...
import { ColorPropType, Platform, requireNativeComponent, StyleSheet, ViewPropTypes, View } from 'react-native'
...
export default class Aircraft extends Component<any> {
    static propTypes = {
        ...ViewPropTypes,
         ...
         * 无人机的唯一标号
         */
        gsmId : PropTypes.string,

        /***
         * 无人机的轨迹
         */

        pathLog: PropTypes.arrayOf(LatLng),
        /**
         * 坐标
         */
...
const AMapAircraft = requireNativeComponent('AMapAircraft', Aircraft)
const InfoWindow = requireNativeComponent('AMapAircraftInfoWindow', {
    propTypes: {
        ...ViewPropTypes,
    },
})
